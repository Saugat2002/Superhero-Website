...
const getDescription = (json) => {
  descriptionOtherDiv.innerHTML = `
    <div class="left flex flex-col">
    <h1
    class=" flex items-center justify-center text-center text-5xl font-mono font-bold text-cyan-600 my-10   hover:text-slate-400 cursor-pointer hover:scale-105 hover:-translate-y-1 transition ease-in-out     duration-300">${json.name}
    </h1>
    <a href="${json.img.url}" target="_blank"
    class="transform motion-reduce:transform-none hover:-translate-y-1 hover:scale-105 transition ease-in-out duration-300">
    <img src="${json.img.url}" alt="" width="350"
    class="rounded-lg hover:ring-2 ring-gray ring-solid" />
    </a>
    </div>
    <div class="text-xl details flex flex-col w-fit space-y-10 mt-36">
    <span class="biography flex flex-col space-x-10 hover:[&>span:nth-child(1)]:text-yellow-500">
    <span class="text-2xl cursor-pointer underline">BIOGRAPHY</span>
    ...
    <span class="powerstats flex flex-col space-x-10 hover:[&>span:nth-child(1)]:text-yellow-500">
    <span class="text-2xl cursor-pointer underline">POWERSTATS</span>
    <ul class="list-disc p-4">
    <li>Intelligence: </li>
    <li>Strength: </li>
    <li>Speed: </li>
    ...
    <span class="appearance flex flex-col space-x-10 hover:[&>span:nth-child(1)]:text-yellow-500 ">
    <span class="text-2xl cursor-pointer underline">APPEARANCE</span>
    <ul class="list-disc p-4">
    <li>Gender: </li>
    <li>Race: </li>
    <li>Height: </li>
    ...
    <span class="work flex flex-col space-x-10 hover:[&>span:nth-child(1)]:text-yellow-500 ">
    <span class="text-2xl cursor-pointer underline">WORK</span>
    <ul class="list-disc p-4">
    <li>Occupation: </li>
    <li>Base: </li>
    </ul>
    </span>
    <span class="connections flex flex-col space-x-10 hover:[&>span:nth-child(1)]:text-yellow-500">
    <span class="text-2xl cursor-pointer underline">CONNECTIONS</span>
    <ul class="list-disc p-4">
